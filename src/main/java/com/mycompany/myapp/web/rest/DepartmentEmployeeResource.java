...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.DepartmentEmployee}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentEmployeeResource {
    ...
    public ResponseEntity<DepartmentEmployee> createDepartmentEmployee(@RequestBody DepartmentEmployee departmentEmployee) throws URISyntaxException {
        ...
        DepartmentEmployee result = departmentEmployeeService.save(departmentEmployee);
    ...
    public ResponseEntity<DepartmentEmployee> updateDepartmentEmployee(@RequestBody DepartmentEmployee departmentEmployee) throws URISyntaxException {
    ...
    public ResponseEntity<DepartmentEmployee> getDepartmentEmployee(@PathVariable Long id) {
        ...
        Optional<DepartmentEmployee> departmentEmployee = departmentEmployeeService.findOne(id);
